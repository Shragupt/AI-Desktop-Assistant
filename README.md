...
📚 **Information Retrieval:** Fetches summarized information from Wikipedia via the wikipedia API.

⚙️ **Task Automation:** Can be extended to open applications, search the web, or execute predefined tasks based on voice input.
